...
<head>
    ...
    <link rel="stylesheet" href="css/mpstyles.css">
    ...
    <script src="js/mpscript.js"></script>
</head>
...
<body class="text-light bg-dark bg-gradient">
 ...
 <header>
            ...
            <ul>
				...
				<li><a href="#">Media</a>
                    <ul>
                        ...
                        <li><a href="./smplayer.php">Music Player</a></li>
                        <li><a href="./video.php">Videos</a></li>
                        <li><a href="./filemgr.php">Files</a></li>
                    </ul>
                 </li>
                <li><a href="#">Effects</a>
    ...
    <main>
        <div class="col-lg-12">
            <h1 class="fw-bolder text-center" id="project-title">Music Player PHP/jQuery/MySQL</h1>
        </div>
                ...
                <div class="row">
                 ...
                 <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        ...
                        <div class="d-flex w-100 justify-content-center">
                            ...
                            <div class="mx-1">
                                <button class="btn btn-sm btn-light bg-gradient text-dark" id="play-btn" data-value="play"><i class="fa fa-play">▶️</i></button>
                            </div>
                            <div class="mx-1">
                                <button class="btn btn-sm btn-light bg-gradient text-dark" id="stop-btn"><i class="fa fa-stop">⏹️</i></button>
                            </div>
                            <div class="mx-1">
            ...
            <div class="modal-dialog modal-dialog-centered modal-md">
                ...
                <div class="modal-body">
                    <div class="container-fluid">
                        <form action="save_music.php" id="music-form" method="POST" enctype="multipart/form-data">
        ...
        <div class="modal text-dark" id="update_music_modal" tabindex="-1">
            <div class="modal-dialog modal-dialog-centered modal-md">
                ...
                <div class="modal-body">
                    <div class="container-fluid">
                        <form action="" id="update-music-form" enctype="multipart/form-data">
                            <input type="hidden" name="id" >
                            <div class="form-group mb-3">
